...
def spatialnr (src, overshoot=2.4, ring=2.4, nr=1.2, rpass=1, sstring="0.0:16.0 0.48:8.0 0.64:0.5 1.0:0.0", lowpass=8):
    ...
    EC      = core.knlm.KNLMeansCL (pad, d=0, a=32, s=0, h=overshoot*e)
    ...
    NR      = core.knlm.KNLMeansCL (ECLN, d=0, a=32, s=4, h=nr)
    OSC     = core.knlm.KNLMeansCL (NR, d=0, a=32, s=0, h=overshoot)
    RC      = ringnr (OSC, ring, rpass, rpass)
    OSCP    = core.knlm.KNLMeansCL (RC, d=0, a=32, s=0, h=overshoot)
    Dif     = core.std.MakeDiff (pad, OSCP)
    Dif     = core.knlm.KNLMeansCL (Dif, d=0, a=32, s=0, h=hmax, rclip=OSCP)
